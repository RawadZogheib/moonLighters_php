...
if(require $locTokenCheck){
	...
	require $_SERVER["DOCUMENT_ROOT"]  . '/moonLighters_php/Contrat/Model/(Model)getContratListConsultant.inc.php';
	...
	mysqli_close($con);
}else require $_SERVER["DOCUMENT_ROOT"]  . '/moonLighters_php/Error/View/(View)errorToken.php';
?>